...
## Features 
- 15 prompts simulating consulting tasks, including:
  - Designing chatbot conversations for financial services
  - Explaining technical concepts in plain language
- Human‑written responses that mimic AI‑powered interactions.
- Prompt review page to revisit past prompts
- Financial report that summarizes and analyze my data from 10-K forms
